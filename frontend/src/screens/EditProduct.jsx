        ...
        try{
         ...
         setloading(false)
          ...
          if(res.data.success===true){
           ...
           toast.success("Product Edited Successfull", {
              'position': 'bottom-right',
              'theme': 'colored'
          })
          navigate("/")
      ...
      <div className='create_product'>
        <h4>Proceed Edit  Product :</h4>
          <form className="create-product-form">
            ...
            {loading ? <div className='reg-input-sub' ><img className='l-i' src={loader} alt='loader' /></div> : <input className='reg-input-sub' value='Edit Product' onClick={handleSubmit} type='submit' />}
          </form>
      </div>
    </div>
  )
